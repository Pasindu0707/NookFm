...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-white via-primary-50/20 to-accent-50/20 dark:from-gray-900 dark:via-gray-800/20 dark:to-gray-900 relative overflow-hidden transition-colors duration-200">
